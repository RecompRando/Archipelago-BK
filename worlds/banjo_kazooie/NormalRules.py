...
def get_location_rules(player, options):
    return {
        ...
        LOC_BEGG_CC_ENTRANCE_UNDERWATER_1:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_CC_ENTRANCE_UNDERWATER_2:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_CC_ENTRANCE_UNDERWATER_3:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_CC_ENTRANCE_UNDERWATER_4:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_CC_ENTRANCE_UNDERWATER_5:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_CC_ENTRANCE_UNDERWATER_6:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_CC_SNIPPETS_PIPE_1:
            lambda state:
            (
                state.has(ITEM_SWIM,player)
            ),
...
# Banjo-Kazooie Collectibles Logic
## ============================================================================
        # GRUNTILDA'S LAIR BLUE EGGS
        # ============================================================================
        ...
        LOC_BEGG_GL_AROUND_FP_PAINTING_4:
            lambda state: True,
        LOC_BEGG_GL_NEAR_STILT_STRIDE_GOBIS_1:
            lambda state:
            (
                state.has(ITEM_STILT_STRIDE, player)
            ),
        LOC_BEGG_GL_NEAR_STILT_STRIDE_GOBIS_2:
            lambda state:
            (
                state.has(ITEM_STILT_STRIDE, player)
            ),
        LOC_BEGG_GL_NEAR_STILT_STRIDE_GOBIS_3:
            lambda state:
            (
                state.has(ITEM_STILT_STRIDE, player)
            ),
        LOC_BEGG_GL_NEAR_STILT_STRIDE_GOBIS_4:
            lambda state:
            (
                state.has(ITEM_STILT_STRIDE, player)
            ),
        LOC_BEGG_GL_350_NOTE_DOOR_STATUE_HAT_1:
            lambda state: True,
        LOC_BEGG_GL_350_NOTE_DOOR_STATUE_HAT_2:
            lambda state: True,
        LOC_BEGG_GL_350_NOTE_DOOR_STATUE_HAT_3:
            lambda state: True,
        LOC_BEGG_GL_350_NOTE_DOOR_STATUE_HAT_4:
            lambda state: True,
        LOC_BEGG_GL_350_NOTE_DOOR_STATUE_HAT_5:
            lambda state: True,
        LOC_BEGG_GL_350_NOTE_DOOR_STATUE_HAT_6:
            lambda state: True,
        LOC_BEGG_GL_BESIDE_GRAVEYARD_ENTRY_1:
            lambda state: True,
        LOC_BEGG_GL_BESIDE_GRAVEYARD_ENTRY_2:
            lambda state: True,
        LOC_BEGG_GL_BESIDE_GRAVEYARD_ENTRY_3:
            lambda state: True,
        LOC_BEGG_GL_BESIDE_GRAVEYARD_ENTRY_4:
            lambda state: True,
        LOC_BEGG_GL_INSIDE_GRAVEYARD_CRACKED_DOOR_1:
            lambda state:
            (
                can_break_breakable_gates(state, player)
            ),
        LOC_BEGG_GL_INSIDE_GRAVEYARD_CRACKED_DOOR_2:
            lambda state:
            (
                can_break_breakable_gates(state, player)
            ),
        LOC_BEGG_GL_INSIDE_GRAVEYARD_CRACKED_DOOR_3:
            lambda state:
            (
                can_break_breakable_gates(state, player)
            ),
        LOC_BEGG_GL_INSIDE_GRAVEYARD_CRACKED_DOOR_4:
            lambda state:
            (
                can_break_breakable_gates(state, player)
            ),
        LOC_BEGG_GL_INSIDE_GRAVEYARD_CRACKED_DOOR_5:
            lambda state:
            (
                can_break_breakable_gates(state, player)
            ),
        LOC_BEGG_GL_INSIDE_GRAVEYARD_CRACKED_DOOR_6:
            lambda state:
            (
                can_break_breakable_gates(state, player)
            ),
        LOC_BEGG_GL_BELOW_MMM_PAINTING_1:
            lambda state: True,
        LOC_BEGG_GL_BELOW_MMM_PAINTING_2:
            lambda state: True,
        LOC_BEGG_GL_BELOW_MMM_PAINTING_3:
            lambda state: True,
        LOC_BEGG_GL_BELOW_MMM_PAINTING_4:
            lambda state: True,
        LOC_BEGG_GL_BELOW_MMM_PAINTING_5:
            lambda state: True,
        LOC_BEGG_GL_BELOW_MMM_PAINTING_6:
            lambda state: True,
        LOC_BEGG_GL_BELOW_MMM_PAINTING_7:
            lambda state: True,
        LOC_BEGG_GL_BELOW_MMM_PAINTING_8:
            lambda state: True,
        LOC_BEGG_GL_BELOW_MMM_PAINTING_9:
            lambda state: True,
        LOC_BEGG_GL_BELOW_MMM_PAINTING_10:
            lambda state: True,
        LOC_BEGG_GL_BETWEEN_CRATES_NEAR_RBB_1:
            lambda state: True,
        LOC_BEGG_GL_BETWEEN_CRATES_NEAR_RBB_2:
            lambda state: True,
        LOC_BEGG_GL_BETWEEN_CRATES_NEAR_RBB_3:
            lambda state: True,
        LOC_BEGG_GL_BETWEEN_CRATES_NEAR_RBB_4:
            lambda state: True,
        LOC_BEGG_GL_NEAR_RBB_PAINTING_1:
            lambda state: True,
        LOC_BEGG_GL_NEAR_RBB_PAINTING_2:
            lambda state: True,
        LOC_BEGG_GL_UPPER_PATH_NEAR_765_DOOR_1:
            lambda state: True,
        LOC_BEGG_GL_UPPER_PATH_NEAR_765_DOOR_2:
            lambda state: True,
        LOC_BEGG_GL_UPPER_PATH_NEAR_765_DOOR_3:
            lambda state: True,
        LOC_BEGG_GL_UPPER_PATH_NEAR_765_DOOR_4:
            lambda state: True,
        LOC_BEGG_GL_GRUNTY_FIGHT_1:
            lambda state: True,
        LOC_BEGG_GL_GRUNTY_FIGHT_2:
            lambda state: True,
        LOC_BEGG_GL_GRUNTY_FIGHT_3:
            lambda state: True,
        LOC_BEGG_GL_GRUNTY_FIGHT_4:
            lambda state: True,
        LOC_BEGG_GL_GRUNTY_FIGHT_5:
            lambda state: True,
        LOC_BEGG_GL_GRUNTY_FIGHT_6:
            lambda state: True,

        # MUMBO'S MOUNTAIN BLUE EGGS
        ...
        LOC_BEGG_MM_CHIMPY_8:
            lambda state: True,
        LOC_BEGG_MM_CHIMPY_9:
            lambda state: True,
        LOC_BEGG_MM_CHIMPY_10:
            lambda state: True,
        LOC_BEGG_MM_CHIMPY_11:
            lambda state: True,
        LOC_BEGG_MM_CHIMPY_12:
            lambda state: True,
        LOC_BEGG_MM_INSIDE_MUMBOS_1:
            lambda state: True,
        LOC_BEGG_MM_INSIDE_MUMBOS_2:
        ...
        LOC_BEGG_TTC_TREE_OVERLOOKING_MAP_PATH_1:
            lambda state:
            (
                state.has(ITEM_CLIMB, player)
            ),
        LOC_BEGG_TTC_TREE_OVERLOOKING_MAP_PATH_2:
            lambda state:
            (
                state.has(ITEM_CLIMB, player)
            ),
        LOC_BEGG_TTC_TREE_OVERLOOKING_MAP_PATH_3:
            lambda state:
            (
                state.has(ITEM_CLIMB, player)
            ),
        LOC_BEGG_TTC_TREE_OVERLOOKING_MAP_PATH_4:
            lambda state:
            (
                state.has(ITEM_CLIMB, player)
            ),
        LOC_BEGG_TTC_CLIFFSIDE_PATH_1:
            lambda state: True,
        LOC_BEGG_TTC_CLIFFSIDE_PATH_2:
            lambda state: True,
        LOC_BEGG_TTC_CLIFFSIDE_PATH_3:
            lambda state: True,
        LOC_BEGG_TTC_CLIFFSIDE_PATH_4:
            lambda state: True,
        LOC_BEGG_TTC_CLIFFSIDE_PATH_5:
            lambda state: True,
        LOC_BEGG_TTC_CLIFFSIDE_PATH_6:
            lambda state: True,
        LOC_BEGG_TTC_CLIFFSIDE_PATH_7:
            lambda state: True,
        LOC_BEGG_TTC_CLIFFSIDE_PATH_8:
            lambda state: True,
        LOC_BEGG_TTC_ROCK_POOL_1:
            lambda state: True,
        LOC_BEGG_TTC_ROCK_POOL_2:
            lambda state: True,
        LOC_BEGG_TTC_ROCK_POOL_3:
            lambda state: True,
        LOC_BEGG_TTC_ROCK_POOL_4:
            lambda state: True,
        LOC_BEGG_TTC_ROCK_POOL_5:
            lambda state: True,
        LOC_BEGG_TTC_ROCK_POOL_6:
            lambda state: True,
        LOC_BEGG_TTC_ROCK_POOL_7:
            lambda state: True,
        LOC_BEGG_TTC_ROCK_POOL_CHEST_1:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_TTC_ROCK_POOL_CHEST_2:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_TTC_ROCK_POOL_CHEST_3:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_TTC_ROCK_POOL_CHEST_4:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_TTC_ROCK_POOL_CHEST_5:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),

        # CLANKER'S CAVERN BLUE EGGS
        ...
        LOC_BEGG_CC_SNIPPETS_PIPE_1:
            lambda state: True,
        LOC_BEGG_CC_SNIPPETS_PIPE_2:
            lambda state: True,
        LOC_BEGG_CC_SNIPPETS_PIPE_3:
            lambda state: True,
        LOC_BEGG_CC_SNIPPETS_PIPE_4:
            lambda state: True,
        LOC_BEGG_CC_SNIPPETS_PIPE_5:
            lambda state: True,
        LOC_BEGG_CC_UNDERNEATH_CLANKER_1:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_CC_UNDERNEATH_CLANKER_2:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_CC_UNDERNEATH_CLANKER_3:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_CC_UNDERNEATH_CLANKER_4:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_CC_UNDERNEATH_CLANKER_5:
            lambda state:
            (
                state.has(ITEM_SWIM, player)
            ),

        # BUBBLEGLOOP SWAMP BLUE EGGS
        
        LOC_BEGG_BGS_BEHIND_MOLEHILL_1:
            lambda state: True,
        LOC_BEGG_BGS_BEHIND_MOLEHILL_2:
            lambda state: True,
        LOC_BEGG_BGS_BEHIND_MOLEHILL_3:
            lambda state: True,
        LOC_BEGG_BGS_BEHIND_MOLEHILL_4:
            lambda state: True,
        LOC_BEGG_BGS_BEHIND_MOLEHILL_5:
            lambda state: True,
        LOC_BEGG_BGS_STUMP_NEAR_GIANT_EGG_1:
            lambda state: True,
        LOC_BEGG_BGS_STUMP_NEAR_GIANT_EGG_2:
            lambda state: True,
        LOC_BEGG_BGS_AROUND_CENTRAL_PLATFORM_TOKEN_1:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_AROUND_CENTRAL_PLATFORM_TOKEN_2:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_AROUND_CENTRAL_PLATFORM_TOKEN_3:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_AROUND_CENTRAL_PLATFORM_TOKEN_4:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_AROUND_CENTRAL_PLATFORM_TOKEN_5:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_AROUND_CENTRAL_PLATFORM_TOKEN_6:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_BEHIND_TANKTUP_1:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_BEHIND_TANKTUP_2:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_BEHIND_TANKTUP_3:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_BEHIND_TANKTUP_4:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_BEHIND_TIPTUP_1:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_BEHIND_TIPTUP_2:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_BEHIND_TIPTUP_3:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_BEHIND_TIPTUP_4:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_MUMBOS_HUT_RACE_1:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_MUMBOS_HUT_RACE_2:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_MUMBOS_HUT_RACE_3:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_MUMBOS_HUT_RACE_4:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_MUMBOS_HUT_RACE_5:
            lambda state:
            (
                can_traverse_bgs(state, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_NEAR_MR_VILE_ENTRY_1:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_NEAR_MR_VILE_ENTRY_2:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_NEAR_MR_VILE_ENTRY_3:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_NEAR_MR_VILE_ENTRY_4:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_NEAR_MR_VILE_ENTRY_5:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_NEAR_MR_VILE_ENTRY_6:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_BEHIND_TIMER_PATH_1:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_BEHIND_TIMER_PATH_2:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_BEHIND_TIMER_PATH_3:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_IN_FRONT_SHOCK_HUTS_1:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_IN_FRONT_SHOCK_HUTS_2:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_IN_FRONT_SHOCK_HUTS_3:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_IN_UNDER_SHOCK_HUTS_1:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_IN_UNDER_SHOCK_HUTS_2:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_IN_UNDER_SHOCK_HUTS_3:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_IN_SWAMP_IN_UNDER_SHOCK_HUTS_4:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_BEHIND_MR_VILE_1:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),
        LOC_BEGG_BGS_BEHIND_MR_VILE_2:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_CROCODILE, player)
            ),

        # FREEZEEZY PEAK BLUE EGGS

        
        LOC_BEGG_FP_BEHIND_BOGGYS_HOUSE_1:
            lambda state: True,
        LOC_BEGG_FP_BEHIND_BOGGYS_HOUSE_2:
            lambda state: True,
        LOC_BEGG_FP_BEHIND_BOGGYS_HOUSE_3:
            lambda state: True,
        LOC_BEGG_FP_BEHIND_BOGGYS_HOUSE_4:
            lambda state: True,
        LOC_BEGG_FP_BEHIND_BOGGYS_HOUSE_5:
            lambda state: True,
        LOC_BEGG_FP_INSIDE_CHRISTMAS_TREE_1:
           lambda state:
            (
                (
                    state.has(ITEM_CLIMB, player) 
        ...
        LOC_BEGG_FP_INSIDE_CHRISTMAS_TREE_2:
           lambda state:
            (
                (
                    state.has(ITEM_CLIMB, player) 
        ...
        LOC_BEGG_FP_INSIDE_CHRISTMAS_TREE_3:
           lambda state:
            (
                (
                    state.has(ITEM_CLIMB, player) 
        ...
        LOC_BEGG_FP_INSIDE_CHRISTMAS_TREE_4:
           lambda state:
            (
                (
                    state.has(ITEM_CLIMB, player) 
        ...
        LOC_BEGG_FP_INSIDE_CHRISTMAS_TREE_5:
           lambda state:
            (
                (
                    state.has(ITEM_CLIMB, player) 
        ...
        LOC_BEGG_FP_INSIDE_CHRISTMAS_TREE_6:
           lambda state:
            (
                (
                    state.has(ITEM_CLIMB, player) 
        ...
        LOC_BEGG_FP_INSIDE_CHRISTMAS_TREE_7:
           lambda state:
            (
                (
                    state.has(ITEM_CLIMB, player) 
        ...
        LOC_BEGG_FP_INSIDE_CHRISTMAS_TREE_8:
           lambda state:
            (
                (
                    state.has(ITEM_CLIMB, player) 
        ...
        LOC_BEGG_FP_INSIDE_CHRISTMAS_TREE_9:
            lambda state:
            (
                (
                    state.has(ITEM_CLIMB, player) 
        ...
        LOC_BEGG_FP_INSIDE_CHRISTMAS_TREE_10:
           lambda state:
            (
                (
                    state.has(ITEM_CLIMB, player) 
        ...
        LOC_BEGG_FP_INSIDE_CHRISTMAS_TREE_11:
           lambda state:
            (
                (
                    state.has(ITEM_CLIMB, player) 
        ...
        LOC_BEGG_FP_INSIDE_CHRISTMAS_TREE_12:
            lambda state:
            (
                (
                    state.has(ITEM_CLIMB, player) 
        ...
        LOC_BEGG_FP_AROUND_GREEN_PRESENT_1:
            lambda state:
            (
                state.has(ITEM_JUMP, player) or
                state.has(ITEM_TALON_TROT, player)
            ),
        LOC_BEGG_FP_AROUND_GREEN_PRESENT_2:
            lambda state:
            (
                state.has(ITEM_JUMP, player) or
                state.has(ITEM_TALON_TROT, player)
            ),
        LOC_BEGG_FP_AROUND_GREEN_PRESENT_3:
            lambda state:
            (
                state.has(ITEM_JUMP, player) or
                state.has(ITEM_TALON_TROT, player)
            ),
        LOC_BEGG_FP_AROUND_GREEN_PRESENT_4:
            lambda state:
            (
                state.has(ITEM_JUMP, player) or
                state.has(ITEM_TALON_TROT, player)
            ),
        LOC_BEGG_FP_SNOWMANS_HAT_1:
            lambda state:
            (
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_FP_SNOWMANS_HAT_2:
            lambda state:
            (
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_FP_SNOWMANS_HAT_3:
            lambda state:
            (
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_FP_SNOWMANS_HAT_4:
            lambda state:
            (
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_FP_SNOWMANS_HAT_5:
            lambda state:
            (
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_FP_SNOWMANS_HAT_6:
            lambda state:
            (
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_FP_SNOWMANS_HAT_7:
            lambda state:
            (
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_FP_WATER_AROUND_CHRISTMAS_TREE_1:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_AROUND_CHRISTMAS_TREE_2:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_AROUND_CHRISTMAS_TREE_3:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_AROUND_CHRISTMAS_TREE_4:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_AROUND_CHRISTMAS_TREE_5:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_AROUND_CHRISTMAS_TREE_6:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_AROUND_CHRISTMAS_TREE_7:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_AROUND_CHRISTMAS_TREE_8:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_ICICLES_NEAR_WOZZA_HONEYCOMB_1:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_ICICLES_NEAR_WOZZA_HONEYCOMB_2:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_ICICLES_NEAR_WOZZA_HONEYCOMB_3:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_ICICLES_NEAR_WOZZA_HONEYCOMB_4:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_NEAR_GREEN_PRESENT_RAMP_1:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_NEAR_GREEN_PRESENT_RAMP_2:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_NEAR_GREEN_PRESENT_RAMP_3:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_NEAR_GREEN_PRESENT_RAMP_4:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_NEAR_GREEN_PRESENT_RAMP_5:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_NEAR_GREEN_PRESENT_RAMP_6:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_NEAR_GREEN_PRESENT_RAMP_7:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_NEAR_GREEN_PRESENT_RAMP_8:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_NEAR_GREEN_PRESENT_RAMP_9:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        LOC_BEGG_FP_WATER_NEAR_GREEN_PRESENT_RAMP_10:
            lambda state:
            (
                state.has(ITEM_TRANSFORMATION_WALRUS, player)
            ),
        # GOBI'S VALLEY BLUE EGGS

        LOC_BEGG_GV_UNDERWATER_OASIS_1:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_GV_UNDERWATER_OASIS_2:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_GV_UNDERWATER_OASIS_3:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_GV_UNDERWATER_OASIS_4:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_GV_UNDERWATER_OASIS_5:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_GV_JINXY_LEFT_PAW_1:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_JINXY_LEFT_PAW_2:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_JINXY_LEFT_PAW_3:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_JINXY_RIGHT_PAW_1:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_JINXY_RIGHT_PAW_2:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_JINXY_RIGHT_PAW_3:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_INSIDE_JINXY_AROUND_TOKEN_1:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_INSIDE_JINXY_AROUND_TOKEN_2:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_INSIDE_JINXY_AROUND_TOKEN_3:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_INSIDE_JINXY_AROUND_TOKEN_4:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_INSIDE_JINXY_AROUND_TOKEN_5:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_INSIDE_JINXY_AROUND_TOKEN_6:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_INSIDE_JINXY_AROUND_TOKEN_7:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_INSIDE_JINXY_AROUND_TOKEN_8:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_WATER_PYRAMID_CLIMB_1:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_CLIMB, player)
            ),
        LOC_BEGG_GV_WATER_PYRAMID_CLIMB_2:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_CLIMB, player)
            ),
        LOC_BEGG_GV_WATER_PYRAMID_CLIMB_3:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_CLIMB, player)
            ),
        LOC_BEGG_GV_WATER_PYRAMID_CLIMB_4:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_CLIMB, player)
            ),
        LOC_BEGG_GV_INSIDE_WATER_PYRAMID_1:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_GV_INSIDE_WATER_PYRAMID_2:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_GV_INSIDE_WATER_PYRAMID_3:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_GV_INSIDE_WATER_PYRAMID_4:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_GV_OUTSIDE_SANDYBUTTS_TOMB_1:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_OUTSIDE_SANDYBUTTS_TOMB_2:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_OUTSIDE_SANDYBUTTS_TOMB_3:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_OUTSIDE_SANDYBUTTS_TOMB_4:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_OUTSIDE_SANDYBUTTS_TOMB_5:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_OUTSIDE_SANDYBUTTS_TOMB_6:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_OUTSIDE_SANDYBUTTS_TOMB_7:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_OUTSIDE_SANDYBUTTS_TOMB_8:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_OUTSIDE_SANDYBUTTS_TOMB_9:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_OUTSIDE_SANDYBUTTS_TOMB_10:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_OUTSIDE_SANDYBUTTS_TOMB_11:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_SANDYBUTTS_MAZE_ENTRY_RIGHT_1:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_SANDYBUTTS_MAZE_ENTRY_RIGHT_2:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_SANDYBUTTS_MAZE_ENTRY_RIGHT_3:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_SANDYBUTTS_MAZE_ENTRY_RIGHT_4:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_SANDYBUTTS_MAZE_NEAR_EXIT_1:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_SANDYBUTTS_MAZE_NEAR_EXIT_2:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_SANDYBUTTS_MAZE_NEAR_EXIT_3:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),
        LOC_BEGG_GV_SANDYBUTTS_MAZE_NEAR_EXIT_4:
            lambda state:
            (
                state.can_reach("Gobi's Valley", 'Region', player)
            ),

        # MAD MONSTER MANSION BLUE EGGS - COMPLETE

        LOC_BEGG_MMM_INSIDE_BACK_GROUND_FLOOR_WINDOW_1:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_INSIDE_BACK_GROUND_FLOOR_WINDOW_2:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_INSIDE_BACK_GROUND_FLOOR_WINDOW_3:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_INSIDE_BACK_GROUND_FLOOR_WINDOW_4:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_INSIDE_BACK_GROUND_FLOOR_WINDOW_5:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_INSIDE_BACK_GROUND_FLOOR_WINDOW_6:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_INSIDE_BACK_GROUND_FLOOR_WINDOW_7:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_INSIDE_BACK_GROUND_FLOOR_WINDOW_8:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_FIRST_FLOOR_ROOF_1:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_FIRST_FLOOR_ROOF_2:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_FIRST_FLOOR_ROOF_3:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_FIRST_FLOOR_ROOF_4:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_PILLOWS_IN_BEDROOM_1:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_PILLOWS_IN_BEDROOM_2:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_PILLOWS_IN_BEDROOM_3:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_MANTLE_1:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_MANTLE_2:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_MANTLE_3:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_MANTLE_4:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_MANTLE_5:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_CELLAR_BARREL_1:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_CELLAR_BARREL_2:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_CELLAR_BARREL_3:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_BEHIND_FOUNTAIN_1:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_BEHIND_FOUNTAIN_2:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_BEHIND_FOUNTAIN_3:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_BEHIND_FOUNTAIN_4:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_NEAR_WELL_1:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_NEAR_WELL_2:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_NEAR_WELL_3:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_NEAR_WELL_4:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_1:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_2:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_3:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_4:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_5:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_6:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_7:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_8:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_9:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_10:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_11:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_12:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_13:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_14:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_15:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_16:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_17:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BK_CHURCH_WINDOW_18:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_HEDGE_MAZE_1:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_HEDGE_MAZE_2:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_HEDGE_MAZE_3:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_CHURCH_BENCH_1:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_CHURCH_BENCH_2:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_CHURCH_BENCH_3:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_CHURCH_BENCH_4:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_CHURCH_BENCH_5:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_CHURCH_BENCH_6:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_CHURCH_BENCH_7:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_CHURCH_BENCH_8:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player)
            ),
        LOC_BEGG_MMM_CHURCH_RAFTERS_1:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_CHURCH_RAFTERS_2:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_CHURCH_RAFTERS_3:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_CHURCH_RAFTERS_4:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_CHURCH_RAFTERS_5:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_CHURCH_RAFTERS_6:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_CHURCH_RAFTERS_7:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_CHURCH_RAFTERS_8:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_CHURCH_RAFTERS_9:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_CHURCH_RAFTERS_10:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_CHURCH_RAFTERS_11:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_CHURCH_RAFTERS_12:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_FLIGHT, player)
            ),
        LOC_BEGG_MMM_BENEATH_FLOORBOARDS_1:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_BEAK_BUSTER, player)
            ),
        LOC_BEGG_MMM_BENEATH_FLOORBOARDS_2:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_BEAK_BUSTER, player)
            ),
        LOC_BEGG_MMM_BENEATH_FLOORBOARDS_3:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_BEAK_BUSTER, player)
            ),
        LOC_BEGG_MMM_BENEATH_FLOORBOARDS_4:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_BEAK_BUSTER, player)
            ),
        LOC_BEGG_MMM_BENEATH_FLOORBOARDS_5:
            lambda state:
            (
                state.can_reach("Mad Monster Mansion", 'Region', player) and
                state.has(ITEM_BEAK_BUSTER, player)
        ...
        # RUSTY BUCKET BAY BLUE EGGS 

        LOC_BEGG_RBB_WORLD_ENTRY_CRATES_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_WORLD_ENTRY_CRATES_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_WORLD_ENTRY_CRATES_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_WORLD_ENTRY_CRATES_4:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_WORLD_ENTRY_CRATES_5:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_NAVIGATION_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_NAVIGATION_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_NAVIGATION_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_NAVIGATION_4:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_FLOODED_WAREHOUSE_BEAM_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_FLOODED_WAREHOUSE_BEAM_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_FLOODED_WAREHOUSE_BEAM_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_FLOODED_WAREHOUSE_BEAM_4:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_FLOODED_WAREHOUSE_BEAM_5:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_WAREHOUSE_CRATE_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_WAREHOUSE_CRATE_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_WAREHOUSE_CRATE_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_WAREHOUSE_CRATE_4:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_WAREHOUSE_CRATE_5:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_WAREHOUSE_CRATE_6:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BETWEEN_SHIPPING_CRATES_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BETWEEN_SHIPPING_CRATES_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BETWEEN_SHIPPING_CRATES_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BETWEEN_SHIPPING_CRATES_4:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_INSIDE_LIFEBOAT_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_INSIDE_LIFEBOAT_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_INSIDE_LIFEBOAT_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_IN_WATER_NEAR_PURPLE_JINJO_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_IN_WATER_NEAR_PURPLE_JINJO_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_IN_WATER_NEAR_PURPLE_JINJO_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_IN_WATER_NEAR_PURPLE_JINJO_4:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_IN_WATER_NEAR_PURPLE_JINJO_5:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_IN_WATER_NEAR_PURPLE_JINJO_6:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_CRATES_NEAR_GIANT_TNT_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_CRATES_NEAR_GIANT_TNT_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_CRATES_NEAR_GIANT_TNT_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_CRATES_NEAR_GIANT_TNT_4:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),

        # RBB Boss Boom Box - All 31 Eggs
        LOC_BEGG_RBB_BOSS_BOOMBOX_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_4:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_5:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_6:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_7:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_8:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_9:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_10:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_11:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_12:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_13:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_14:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_15:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_16:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_17:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_18:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_19:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_20:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_21:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_22:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_23:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_24:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_25:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_26:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_27:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_28:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_29:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_30:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_BOSS_BOOMBOX_31:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),

        LOC_BEGG_RBB_STOREROOM_PERISCOPE_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_STOREROOM_PERISCOPE_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_STOREROOM_PERISCOPE_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_STOREROOM_PERISCOPE_4:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_STOREROOM_PERISCOPE_5:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_KITCHEN_FRIDGE_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_KITCHEN_FRIDGE_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_KITCHEN_FRIDGE_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_KITCHEN_FRIDGE_4:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_KITCHEN_FRIDGE_5:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_KITCHEN_FRIDGE_6:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_KITCHEN_FRIDGE_7:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_KITCHEN_FRIDGE_8:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_KITCHEN_FRIDGE_9:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_PROPELLER_WINDOW_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_PROPELLER_WINDOW_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_PROPELLER_WINDOW_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_PROPELLER_WINDOW_4:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player)
            ),
        LOC_BEGG_RBB_UNDERWATER_ANCHOR_SWITCH_1:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_UNDERWATER_ANCHOR_SWITCH_2:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_UNDERWATER_ANCHOR_SWITCH_3:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
            ),
        LOC_BEGG_RBB_UNDERWATER_ANCHOR_SWITCH_4:
            lambda state:
            (
                state.can_reach("Rusty Bucket Bay", 'Region', player) and
                state.has(ITEM_SWIM, player)
        ...
        # CLICK CLOCK WOOD BLUE EGGS 

        LOC_BEGG_CCW_OUTSIDE_WINTER_DOOR_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_OUTSIDE_WINTER_DOOR_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_OUTSIDE_WINTER_DOOR_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_OUTSIDE_WINTER_DOOR_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        ...
        # Spring Season Eggs
        LOC_BEGG_CCW_SPRING_STUMP_IN_WATER_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_STUMP_IN_WATER_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_STUMP_IN_WATER_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_STUMP_IN_WATER_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_INSIDE_MUMBOS_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_INSIDE_MUMBOS_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_INSIDE_MUMBOS_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_INSIDE_MUMBOS_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_5:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_6:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_7:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_8:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_9:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_10:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_11:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_12:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_13:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_TREE_BASE_14:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_BEFORE_HIVE_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_BEFORE_HIVE_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_BEFORE_HIVE_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_BEFORE_HIVE_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_PATH_CABIN_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_PATH_CABIN_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_PATH_CABIN_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_PATH_CABIN_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_PATH_CABIN_5:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_UNFINISHED_PATH_NABNUT_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_UNFINISHED_PATH_NABNUT_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_UNFINISHED_PATH_NABNUT_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_UNFINISHED_PATH_NABNUT_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_NABNUT_SHELF_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_NABNUT_SHELF_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_NABNUT_SHELF_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_5:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_6:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_7:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_8:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_9:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_10:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_11:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_12:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SPRING_EYRIE_NEST_13:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        ...
        # Summer Season Eggs
        LOC_BEGG_CCW_SUMMER_BRAMBLE_SHOCK_PAD_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_BRAMBLE_SHOCK_PAD_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_BRAMBLE_SHOCK_PAD_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_BRAMBLE_SHOCK_PAD_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_BRAMBLE_SHOCK_PAD_5:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_BRAMBLE_SHOCK_PAD_6:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_NEAR_PLANT_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_NEAR_PLANT_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_NEAR_PLANT_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_NEAR_PLANT_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_NEAR_PLANT_5:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_NEAR_PLANT_6:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_NEAR_PLANT_7:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_NEAR_PLANT_8:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_OUTSIDE_NABNUTS_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_OUTSIDE_NABNUTS_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_OUTSIDE_NABNUTS_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_OUTSIDE_NABNUTS_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_OUTSIDE_NABNUTS_5:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_SUMMER_OUTSIDE_NABNUTS_6:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        ...
        # Autumn Season Eggs
        LOC_BEGG_CCW_AUTUMN_ENTRY_LEAVES_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_ENTRY_LEAVES_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_IN_BRAMBLES_NEAR_MUMBO_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_IN_BRAMBLES_NEAR_MUMBO_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_IN_BRAMBLES_NEAR_MUMBO_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_GNAWTY_SHELF_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_GNAWTY_SHELF_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_GNAWTY_SHELF_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_ABOVE_BRAMBLES_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_ABOVE_BRAMBLES_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_ABOVE_BRAMBLES_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_ABOVE_BRAMBLES_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_ABOVE_BRAMBLES_5:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_ABOVE_BRAMBLES_6:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_OUTSIDE_CABIN_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_OUTSIDE_CABIN_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_NABNUTS_UPPER_WINDOW_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_NABNUTS_UPPER_WINDOW_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_NABNUTS_UPPER_WINDOW_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_NEAR_EYRIE_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_NEAR_EYRIE_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_AUTUMN_NEAR_EYRIE_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        ...
        # Winter Season Eggs
        LOC_BEGG_CCW_WINTER_NABNUT_UPPER_WINDOW_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_WINTER_NABNUT_UPPER_WINDOW_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_WINTER_NABNUT_UPPER_WINDOW_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_WINTER_NABNUT_UPPER_WINDOW_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_WINTER_NABNUT_UPPER_WINDOW_5:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_WINTER_NABNUT_UPPER_WINDOW_6:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player) 
            ),
        LOC_BEGG_CCW_WINTER_NABNUT_UPPER_WINDOW_7:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_WINTER_NABNUT_UPPER_WINDOW_8:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_WINTER_NABNUTS_SHELF_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_WINTER_NABNUTS_SHELF_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player) 
            ),
        LOC_BEGG_CCW_WINTER_NABNUTS_SHELF_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_WINTER_NABNUTS_SHELF_4:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player) 
            ),
        LOC_BEGG_CCW_WINTER_NABNUTS_SHELF_5:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player) 
            ),
        LOC_BEGG_CCW_WINTER_NABNUTS_HONEYCOMB_1:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player) 
            ),
        LOC_BEGG_CCW_WINTER_NABNUTS_HONEYCOMB_2:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
        LOC_BEGG_CCW_WINTER_NABNUTS_HONEYCOMB_3:
            lambda state:
            (
                state.can_reach("Click Clock Wood", 'Region', player)
            ),
